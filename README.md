...
The solution given uses the Multi-agent DDPG approach. For implementation details, please see Report.pdf and the iPython code and comments.
...
```bash
git clone https://github.com/dantodor/drl-tennis.git
cd drl-tennis
pip install .
```
